...
ss3m6@mail.umkc.edu
CS-201
Assignment 03- pizza.cpp
Due 6/26/17
Description: This program is about total sale in pizza shop, it explains number of items of each type were sold. The total sales for each type. Items discounted and was the total amount of all discounts given.

Inputs: Data file.
Outputs: Various status messages, to screen.
Error handling: None.
Algorithm:
1. Define the base class and derived classes with variables in it.
2. Setters and getters for base and derived classes
